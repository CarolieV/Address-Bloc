...
book.add_entry('Ada Lovelace', '010.012.1815', 'augusta.king@lovelace.com')
   ...
   describe "#import_from_csv_2#" do
       ...
       # #5
       check_entry(entry_one, "Jane", "555-555-5553", "jane@blocmail.com")

       it "imports the 2nd entry" do
       book.import_from_csv("entries.csv")
       # Check the second entry
       entry_two = book.entries[1]
       check_entry(entry_two, "Billie", "555-555-5554", "billie@blocmail.com")
     end
     ...
     it "imports the 3rd entry" do
       ...
       # Check the third entry
       entry_three = book.entries[2]
       check_entry(entry_three, "GenericName", "555-555-5555", "generic_name@blocmail.com")
